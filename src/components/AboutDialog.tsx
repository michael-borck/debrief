    ...
    >
        ...
        <div className="border-b border-surface-200 p-6">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-semibold text-surface-900">About Debrief</h2>
            <button
              onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="text-center">
            ...
            <h3 className="text-3xl font-display text-surface-900">Debrief</h3>
