...
export const SettingsPage: React.FC = () => {
  ...
  const handleBackupNow = async () => {
    const result = await window.electronAPI.dialog.saveFile({
      defaultPath: `debrief-backup-${new Date().toISOString().split('T')[0]}.db`,
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="panel">
              ...
              <p className="text-sm text-surface-600 mb-5">
                Choose where Debrief sends transcripts for summarisation, sentiment, and other AI analysis. Local Ollama keeps everything on your machine; cloud providers give you access to more powerful models in exchange for sending transcripts to their servers.
              </p>
                    ...
                    return (
                      <div className="space-y-4">
                        {renderBlock(
                          ...
                          'No AI requests yet this session. Resets when Debrief restarts.'
                        )}
                        {renderBlock(
                          'Lifetime',
                          usageStats?.lifetime,
          ...
          <div className="space-y-6">
            ...
            <div className="panel">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  onClick={() => {
                    try {
                      localStorage.removeItem('debrief:welcomeSeenV1');
            ...
            <div className="panel">
              ...
              <div className="text-sm text-surface-600 space-y-2">
                <p>
                  Debrief stores all data locally on your computer in a SQLite database.
                ...
                <p>
                  ...
                  Debrief falls back to plain text and warns you.
                </p>
              </div>
            </div>
          </div>
