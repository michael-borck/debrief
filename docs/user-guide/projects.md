...
Projects group related transcripts so Debrief can analyse them together. A single interview is a transcript. A batch of twelve interviews for the same study is a project.
...
- **Semantic** — vector-based similarity using the embeddings Debrief builds for chat
