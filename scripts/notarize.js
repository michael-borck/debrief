...
// notarize wrapper (buggy across recent versions) and calls @electron/notarize
// directly. Skipped on non-mac builds and when Apple credentials aren't set
// (local dev / PR builds without the secret).
